<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ekle.aspx.cs" Inherits="HastaneRandevuSistemi.Pages.Admin.Hastane.Ekle" %>
            ...
            <article class="card-body mx-auto" style="max-width: 800px;">
                <form id="form1" runat="server" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col">
                            <asp:DropDownList ID="sehirDDL" runat="server" class="form-control" DataSourceID="sehirSqlDataSource" DataTextField="SehirAdi" DataValueField="Id" AutoPostBack="True"></asp:DropDownList>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col">
                            <asp:DropDownList ID="klinikDDL" runat="server" class="form-control" DataSourceID="klinikSqlDataSource" DataTextField="KlinikAdi" DataValueField="Id"></asp:DropDownList>
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblHastaneAdi" runat="server" Text="Hastane Adı" CssClass="col-sm-3 control-label"></asp:Label>
                        <div class="col">
                            <asp:TextBox ID="txtBoxHastaneAdi" runat="server" placeholder="Hastane adını girin" class="form-control" required="required"></asp:TextBox>
                        </div>
                    </div>
